...
RSpec.describe "/specialties", type: :request do
  ...
  # SpecialtiesController, or in your router and rack
  ...
  describe "GET /index" do
    it "renders a successful response" do
      ...
      get specialties_url, headers: valid_headers, as: :json
  ...
  describe "POST /create" do
      ...
      it "creates a new Specialty" do
        expect {
          post specialties_url,
               params: { specialty: valid_attributes }, headers: valid_headers, as: :json
    ...
    context "with invalid parameters" do
      it "does not create a new Specialty" do
        expect {
          post specialties_url,
               params: { specialty: invalid_attributes }, as: :json
        }.to change(Specialty, :count).by(0)
      end

      it "renders a JSON response with errors for the new specialty" do
        post specialties_url,
             params: { specialty: invalid_attributes }, headers: valid_headers, as: :json
  ...
  describe "PATCH /update" do
    context "with valid parameters" do
      ...
      it "updates the requested specialty" do
        specialty = Specialty.create! valid_attributes
        patch specialty_url(specialty),
              params: { specialty: new_attributes }, headers: valid_headers, as: :json
        specialty.reload
  ...
  describe "DELETE /destroy" do
    it "destroys the requested specialty" do
      specialty = Specialty.create! valid_attributes
      expect {
        delete specialty_url(specialty), headers: valid_headers, as: :json
      }.to change(Specialty, :count).by(-1)
    end
  end
end
