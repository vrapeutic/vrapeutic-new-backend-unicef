...
RSpec.describe "/admins", type: :request do
  ...
  # AdminsController, or in your router and rack
  ...
  describe "GET /index" do
    it "renders a successful response" do
      ...
      get admins_url, headers: valid_headers, as: :json
  ...
  describe "POST /create" do
    context "with valid parameters" do
      it "creates a new Admin" do
        expect {
          post admins_url,
               params: { admin: valid_attributes }, headers: valid_headers, as: :json
    ...
    context "with invalid parameters" do
      it "does not create a new Admin" do
        expect {
          post admins_url,
               params: { admin: invalid_attributes }, as: :json
        }.to change(Admin, :count).by(0)
      end

      it "renders a JSON response with errors for the new admin" do
        post admins_url,
             params: { admin: invalid_attributes }, headers: valid_headers, as: :json
    ...
    context "with valid parameters" do
      ...
      it "updates the requested admin" do
        ...
        patch admin_url(admin),
              params: { admin: new_attributes }, headers: valid_headers, as: :json
        admin.reload
  ...
  describe "DELETE /destroy" do
    it "destroys the requested admin" do
      admin = Admin.create! valid_attributes
      expect {
        delete admin_url(admin), headers: valid_headers, as: :json
      }.to change(Admin, :count).by(-1)
    end
  end
end
